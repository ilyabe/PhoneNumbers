...
{
// No Google Analytics tracking for this site.
...
// Created: 9/15/2010 4:56:34 PM

function WebTrends(){
	var that=this;
	// begin: user modifiable
	this.dcsid="dcsnvpdarvz5bd6lbj3xgktbw_7i2o";
	this.domain="statse.webtrendslive.com";
	this.timezone=-6;
	this.fpcdom=".mcdonalds.com";
	this.onsitedoms="";
	this.downloadtypes="xls,doc,pdf,txt,csv,zip,mov,mp4,flv,xml";
	this.formnames="locator_frm,search_frm,restaurantinputbox_frm,emailform,searchFormBean,tripplannerFrm,routeForm1";
...
// Add specific form detection.
				if (this.dcsFormMatch(ttl, this.formnames)){
...
// User-created function to identify specific forms.
WebTrends.prototype.dcsFormMatch=function(ttl, formnames){
	var name=ttl.toLowerCase().substring(ttl.lastIndexOf(".")+1,ttl.length);
	var names=this.dcsSplit(formnames);
	var tlen=names.length;	
	for (var i=0;i<tlen;i++){
		if (name==names[i]){
			return true;
		}
