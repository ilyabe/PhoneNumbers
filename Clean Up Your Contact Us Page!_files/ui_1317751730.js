...
{if((undefined!=$iTXT.core.Browser.ie8CompatMode)&&(this.transparentTooltip&&($iTXT.core.Browser.is("Explorer",8)||$iTXT.core.Browser.ie8CompatMode||$iTXT.core.Browser.quirksMode||($iTXT.core.Browser.is("Explorer",7)&&!$iTXT.core.Browser.ie8CompatMode))))
{this.whAdjust=1;}
else
{this.whAdjust=0;}}});}
...
$iTXT.js.loader["$iTXT.ui.LightboxChrome"]=true;$iTXT.ui.LightboxAVTrigger={ONBUFFER:0,ONOPEN:1}
$iTXT.ui.LightboxChrome_Load=function(){var undefined;$iTXT.ui.LightboxChrome=$iTXT.core.Class.create($iTXT.ui.ComponentBase,{advert:null,init:function(_options,$super)
...
{this.rootElement.mask=$iTXT.core.Builder.make("DIV",{id:"itxtLboxMask"},[]);this.rootElement.mask.itxtSetStyle({background:"#000",position:"fixed",top:"0px",left:"0px",width:"100%",height:"100%",zIndex:this.options.zIndex,overflow:"visible",opacity:".8",filter:"alpha(opacity = 80)"});}
else
{this.rootElement.mask=existingMask;}
this.rootElement.mask.itxtHide();this.rootElement.itxtHide();document.body.appendChild(this.rootElement);document.body.appendChild(this.rootElement.mask);}},_unitClick:function(e)
...
{},createFlash:function(overlaySrc)
{var flashProperties={width:"800",height:"800",id:this.options.id+"MC",name:this.options.id+"MC",src:overlaySrc,data:overlaySrc,style:"display: block",scale:"exactfit",quality:"high",wmode:"transparent",swliveconnect:"true",allowscriptaccess:"always",type:"application/x-shockwave-flash",bgcolor:"transparent"};if($iTXT.core.Browser.is("Explorer"))
...
this.lboxMC=objNode;}else{this.lboxMC=$iTXT.core.Builder.make("EMBED",flashProperties);}
var contDiv=document.createElement("div");contDiv.appendChild(this.lboxMC);this.lboxMC=undefined;var unit=$iTXT.core.Builder.make("DIV",{id:"itxtLboxUnit"});unit.itxtSetStyle({width:"800px",height:"800px",margin:"0 auto",zIndex:this.options.zIndex+1000});unit.innerHTML=contDiv.innerHTML;unit.itxtBatchSubscribe([["mouseup",$iTXT.core.Event.bind(this,this._onMouseDownUp)],["mousedown",$iTXT.core.Event.bind(this,this._onMouseDownUp)],["contextmenu",$iTXT.core.Event.bind(this,this._onMouseDownUp)],["click",$iTXT.core.Event.bind(this,this._unitClick)]],this.evtDspFuncs);return unit;},show:function(ad)
{this.advert=ad;var overlaySrc=ad.params.get("lboxsrc");this.rootElement.wrapper.appendChild(this.createFlash(overlaySrc));this.rootElement.mask.itxtShow();this.rootElement.itxtShow();},hide:function()
{this.rootElement.mask.itxtHide();this.rootElement.itxtHide();var flash=document.getElementById(this.options.id+"MC");if(flash)
{try
{flash.muteVideo();}
catch(e)
{}}
this.rootElement.wrapper.itxtClear();}});}
$iTXT.js.loader["$iTXT.ui.MobileTooltip"]=true;$iTXT.ui.MobileTooltip_Load=function(){var undefined;$iTXT.ui.MobileTooltip=$iTXT.core.Class.create($iTXT.ui.Tooltip,{deviceWidth:0,zoom:2,init:function(_options,$super)
{if($iTXT.data.al)
{$iTXT.data.al.allowHookClick=false;}
$super(_options);this.zIndex=9910000;this.updateDeviceScale();$iTXT.core.$(window).itxtSubscribe("resize",$iTXT.core.Event.bind(this,this.onResize));$iTXT.core.$(window).itxtSubscribe("orientationchange",$iTXT.core.Event.bind(this,this.onOrientationChange));$iTXT.core.$(document).itxtSubscribe("touchmove",$iTXT.core.Event.bind(this,this.onTouchMove));},onResize:function()
{if(!this.isOpen)
...
this.scaleMask();this.scaleTooltip();this.placeTooltip();},build:function()
{$iTXT.core.$("itxtttholder").itxtSetStyle({webkitPerspective:"1000",webkitTransformStyle:"flat"});this.maskDiv=$iTXT.core.Builder.make("DIV",{style:"background-image: url(http://images.intellitxt.com/ast/tt/mobile/bg_px.png);position:absolute; left: 0px; top: 0px;-webkit-user-select: none;-webkit-transform-style: flat;"});this.maskDiv.style.zIndex=this.zindex-100;this.maskDiv.itxtHide();this.maskDiv.itxtSubscribe("click",$iTXT.core.Event.bind(this,this._maskClick));$iTXT.core.$("itxtttholder").appendChild(this.maskDiv);this.rootElement.itxtSetStyle({backgroundColor:"white",webkitBackfaceVisibility:"hidden",webkitBorderRadius:"5px",webkitBoxShadow:"0px 2px 8px #000000",zoom:this.zoom,zIndex:this.zIndex});$iTXT.debug.info($iTXT.debug.Category.UI,"Tooltip.build()");this.chrome=new $iTXT.ui.MobileTooltipChrome({ps:this.options.ps,bgcol:this.options.bgcol,draggable:this.options.draggable});this.chrome.build();this.addChild(this.chrome);this.content=new $iTXT.ui.TooltipContent({ps:this.options.ps,bgcol:this.options.bgcol});this.chrome.rootElement.appendChild(this.content.rootElement);this.rootElement.itxtSubscribe("touchmove",$iTXT.core.Event.bind(this,this.onTouchMove));},onTouchMove:function(e)
{if(this.isOpen)
{e.preventDefault();return false;}},open:function()
{$iTXT.debug.info($iTXT.debug.Category.UI,"Start MobileTooltip Open");$iTXT.core.$(document).itxtFire("$iTXT:tt:before:open");this.hide();this.content.hide();this.chrome.hide();this.rootElement.itxtRemoveClass("minimise");this.scaleMask();this.placeTooltip();var metas=document.getElementsByTagName("meta");if(!$iTXT.core.Browser.isPlatform(["Android"]))
...
{var opts=e.data||{};$iTXT.core.$(document).itxtFire("$iTXT:tt:before:close");this.content.beforeClose();this.rootElement.style.webkitTransitionTimingFunction="ease-out";this.rootElement.style.webkitTransitionDuration="0.3s";this.rootElement.style.webkitTransform=this.getRotateString();this.rootElement.style.opacity=0;if(!$iTXT.core.Browser.isPlatform(["Android"]))
{if(this.orgZoomable)
{var metas=document.getElementsByTagName("meta");for(var m in metas)
{if(metas[m].name=="viewport"&&metas[m].content.indexOf("user-scalable=no")>-1)
{metas[m].content="user-scalable=yes";break;}}}}
window.setTimeout($iTXT.core.Event.bind(this,this._finishRotateClose),500);},_contentLoaded:function()
{if(!this.options.invisible)
{this.show();this.content.show();this.chrome.show();this.rootElement.style.opacity=0;var newSize=this.content.tryResize(null,null);this._setContentSize(newSize[0],newSize[1],0);var advertWidth=newSize[0]+100;this.placeTooltip();$iTXT.core.$(document).itxtFire("$iTXT:tt:ready");this.rootElement.style.webkitTransform=this.getRotateString();this.isOpen=true;this.openTS=(new Date).getTime();this.content.hide();window.setTimeout($iTXT.core.Event.bind(this,this._fadeMask),50);}
...
{this.rootElement.style.webkitTransitionTimingFunction="";this.rootElement.style.webkitTransitionDuration="";},placeTooltip:function()
{var winSize=$iTXT.core.Util.getWindowSize();var pageScroll=$iTXT.core.Util.getPageScroll();var landscape=Math.abs(window.orientation)===90;var sideLength=landscape?this.height:this.width;var deviceLength=landscape?winSize.height:winSize.width;if(Math.abs(window.orientation)===90)
{this.zoom=Math.max(Math.round((winSize.height*0.8)/this.height),1);}
else
{this.zoom=Math.max(Math.round((winSize.width*0.7)/this.width),1);}
if($iTXT.glob.params.getBool('js.mobile.ignoreDeviceZoom',false))
{this.zoom=1;}
...
{$iTXT.debug.info($iTXT.debug.Category.UI,"All Template Content Loaded");var td=(new Date()).getTime()-this.ccTS;var tout=Math.max(250-td,0);$iTXT.debug.info($iTXT.debug.Category.UI,"Sleeping Template Display For: "+tout+"ms");$iTXT.core.$(document).itxtFire("$iTXT:tt:content:loaded",{loadTimeout:tout});},beforeOpen:function()
{if(null!=this.template)
...
$iTXT.js.loader["$iTXT.ui.Hook"]=true;$iTXT.ui.Hook_Load=function(){var undefined;$iTXT.ui.HookManager={id:0,hookedCounter:0,textNodes:[],hooks:[],startIndex:0,unHookedHooks:[],initSkip:0,maxKWNode:5,maxKWPara:5,keywordPadding:0,keywordInterval:0,placePerParagraph:0,paragraphCounts:{},specialChars:{},nodeID:1,add:function(hook)
{if(hook)
...
{var kw=okw=hk.options.value;var specialChar=(1===this.specialChars[okw]);kw=kw.replace(/(\+|\(|\.|\[|\-|\$|\<|\{|\%|\!|\)|\]|\?)/g,'\\$1');kw=kw.replace(/\ /g,'\\s+');var flags="gm";if(!hk.options.cs)
{flags+="i";}
var leftREChars="(\\b|\u201C|\u2018|\\s)",rightREChars="(\\b|\u201D|\\s|\\.|\\,|\\?|\\!)"
plauralChars="(?:[\x27\u2019]s?)?";if(specialChar)
{leftREChars="";rightREChars="";plauralChars="";}
var kwRegEx=new RegExp(leftREChars+kw+rightREChars+plauralChars,flags);var match,foundHk=false,offset=0;while((match=kwRegEx.exec(t))&&!foundHk)
...
{spanStyle+="border-bottom: 2px solid transparent";}
...
kwID++;}
this.rootElement=b.make("A",{href:this.options.clickUrl,id:"itxthook"+this.options.id,rel:"nofollow"},this.childSpans);this.rootElement.itxtSetStyle(this.options.hookStyle);if($iTXT.core.Browser.is("Chrome")||$iTXT.core.Browser.is("Safari"))
{this.rootElement.style.borderBottomWidth="0.1em";}
...
this.rootElement.style.cssText=this.options.hookStyle;if($iTXT.core.Browser.is("Chrome")||$iTXT.core.Browser.is("Safari"))
{this.rootElement.style.borderBottomWidth="0.1em";}}
...
{var defOpts=$iTXT.core.Util.extend({id:"itxttt",ps:$iTXT.ui.TooltipPosition.AR,bgcol:"#fbfbfb",hbgcol:'#f6f6f6',ftrbgcol:'#fbfbfb',tailbgcol:'#fbfbfb',minShowTime:0,tthd:1500,mintthd:0,openDelay:100,draggable:true,invisible:false,fadeShadow:true},_options);$iTXT.glob.dbParams.set('tt.img.dir',this.defaultImageDirectory,$iTXT.cnst.WEIGHTING_DEFAULT_DEFAULT);$iTXT.debug.info($iTXT.debug.Category.UI,"Creating Tooltip");this.zindex=9910000;$super(defOpts);this.rootElement.style.zIndex=this.zindex;var t=this;var evt=$iTXT.core.Event;this.rootElement.itxtBatchSubscribe([["mouseover",$iTXT.core.Event.bind(this,this._onMouseOver)],["mouseout",$iTXT.core.Event.bind(this,this._onMouseOut)],["mouseup",$iTXT.core.Event.bind(this,this._onMouseDownUp)],["mousedown",$iTXT.core.Event.bind(this,this._onMouseDownUp)],["contextmenu",$iTXT.core.Event.bind(this,this._onMouseDownUp)]],this.evtDspFuncs);$iTXT.core.$(document.body).itxtBatchSubscribe([["mouseover",$iTXT.core.Event.bind(this,this._bodyOver)],["mouseup",$iTXT.core.Event.bind(this,this._hdrUp)]],this.evtDspFuncs);$iTXT.core.$(document).itxtBatchSubscribe([["mousemove",evt.bind(this,this._onBodyMouseMove)],["$iTXT:tt:close",evt.bind(this,this.close)],["$iTXT:tt:expand",evt.bind(this,this._expand)],["$iTXT:hook:over",evt.bind(this,this._hookOver)],["$iTXT:hook:in",evt.bind(this,this._hookIn)],["$iTXT:hook:out",evt.bind(this,this._hookOut)],["$iTXT:hook:click",evt.bind(this,this._hookClick)],["$iTXT:tt:hdr:mouse:down",evt.bind(this,this._hdrDown)],["$iTXT:tt:hdr:mouse:up",evt.bind(this,this._hdrUp)],["$iTXT:tt:resize",evt.bind(this,this._resizeTooltip)],["$iTXT:tt:resize:smooth",evt.bind(this,this._smoothResizeTooltip)],["$iTXT:tt:set:fixed:open",evt.bind(this,this._setFixedOpen)],["$iTXT:tt:over",evt.bind(this,this._ttOver)],["$iTXT:tt:out",evt.bind(this,this._ttOut)],["$iTXT:tt:content:change:ad",evt.bind(this,this._changeAdvert)],["$iTXT:tt:content:loaded",$iTXT.core.Event.bind(this,this._contentLoaded)],["$iTXT:function:mvuExpand",evt.bind(this,this._mvuExpand)],["$iTXT:function:fExp",evt.bind(this,this._fExp)],["$iTXT:function:fClick",evt.bind(this,this._fClick)],["$iTXT:tt:iframe:out",evt.bind(this,this._iframeOut)],["$iTXT:tt:global:set:bgcol",$iTXT.core.Event.bind(this,this._setBGCol)],["$iTXT:tt:global:set:hvcol",$iTXT.core.Event.bind(this,this._setHVCol)]],this.evtDspFuncs);this.hide();},build:function()
{$iTXT.debug.info($iTXT.debug.Category.UI,"Tooltip.build()");this.shadow=new $iTXT.ui.TooltipShadow({ps:this.options.ps,bgcol:this.options.bgcol});this.addChild(this.shadow);this.chrome=new $iTXT.ui.TooltipChrome({ps:this.options.ps,bgcol:this.options.bgcol,draggable:this.options.draggable});this.chrome.build();this.addChild(this.chrome);this.content=new $iTXT.ui.TooltipContent({ps:this.options.ps,bgcol:this.options.bgcol});this.chrome.rootElement.appendChild(this.content.rootElement);},setPositionState:function(ps)
{if(ps)
{$iTXT.debug.info($iTXT.debug.Category.UI,"Setting Tooltip Position State: "+ps);this.ps=ps;if(this.shadow)
this.shadow.setPositionState(ps);this.chrome.setPositionState(ps);}},setSize:function(w,h,resizeContent,$super)
{$iTXT.debug.info($iTXT.debug.Category.UI,"Setting Tooltip Size (width: "+w+", height: "+h+")");var shadSize=(this.shadow)?this.shadow.getShadowSize():0;$iTXT.debug.debug($iTXT.debug.Category.UI,"shadow size:"+shadSize+"px");this.chrome.setPosition(shadSize,shadSize);if(resizeContent)
{$iTXT.debug.debug($iTXT.debug.Category.UI,"resizing content");this.content.resize(null,null,false);}
var contentW=this.content.getWidth();var contentH=this.content.getHeight();var contentOverlap=this.content.heightOverlap;$iTXT.debug.debug($iTXT.debug.Category.UI,"content w/h: "+contentW+"px/"+contentH+"px");$iTXT.debug.debug($iTXT.debug.Category.UI,"overlap: "+contentOverlap);this.chrome.setSize(contentW,contentH-contentOverlap,contentOverlap);if(this.shadow)
this.shadow.setSize(this.chrome.getWidth(),this.chrome.getHeight());var contentOff=this.chrome.getContentOffset();this.content.setPosition(contentOff[0],contentOff[1]);var thisHeight=Math.max(((this.shadow)?this.shadow.getHeight():0),this.chrome.getOverlappedHeight());$super(((this.shadow)?this.shadow.getWidth():contentW),thisHeight);},open:function(l,t,state)
{$iTXT.debug.info($iTXT.debug.Category.UI,"Start Tooltip Open l: "+l+"px, t: "+t+"px, state: "+state);$iTXT.core.$(document).itxtFire("$iTXT:tt:before:open");this.hide();this.content.hide();if(this.shadow)
this.shadow.hide();this.chrome.hide();this.setPositionState(state);this.rootElement.itxtRemoveClass("minimise");this.setPosition(l,t);this.setSize(null,null,false);if(!this.options.invisible)
...
{var ttOff=this.rootElement.itxtTotalOffset();var dX=(this.currentHookBB.left-ttOff.left)+(this.currentHookBB.width/2);var dY=this.currentHookBB.top-ttOff.top;this.rootElement.itxtAddClass("minimise");this.content.hide();if(this.shadow)
this.shadow.hide();this.chrome.hide();var t=this;var combOpts={start:true,duration:150,effects:[new $iTXT.fx.Move({target:this.rootElement,dX:dX,dY:dY}),new $iTXT.fx.Size({target:this.rootElement,width:5,height:5})],afterFinish:function()
...
this.show();this.content.show();if(this.shadow)
this.shadow.show();this.chrome.show();this.setSize(null,null,true);this.hide();this.content.hide();if(this.shadow)
this.shadow.hide();this.chrome.hide();var placeOpts={bb:bb,tt:$iTXT.ui.tt};this.content.beforeOpen();if(this.options.invisible)
...
{this.showTail();this.currentAdvert=advert;this.currentHook=null;this.currentHookBB=null;this.setAdvert(advert);this.show();this.content.show();if(this.shadow)
this.shadow.show();this.chrome.show();this.setSize(null,null,true);this.hide();this.content.hide();if(this.shadow)
this.shadow.hide();this.chrome.hide();this.content.beforeOpen();this.onTooltipOpen({left:leftPos,top:topPos,state:posState});this.content.afterOpen();$iTXT.core.$(document).itxtFire("$iTXT:tt:open",{advert:advert});},_onMouseOver:function(e)
...
{adHvBgColor="#f6f6f6";}
this.options.hbgcol=$iTXT.core.Util.validHexColor(tmplopts.ttbghcol||adHvBgColor);this.options.tthd=adopts.getInt("tthd",this.defaultOptions.tthd);this.chrome.setAdvert(ad);if(this.shadow)
this.shadow.setAdvert(ad);if(this.options.invisible)
...
$iTXT.core.$(document).itxtFire("$iTXT:tt:ready");}}}
...
{var opts=e.data||{};var loadTimeout=opts.loadTimeout||0;var t=this;window.setTimeout(function(){t._smoothResizeTooltip()},loadTimeout);}});}
$iTXT.js.loader["$iTXT.ui.TooltipChrome"]=true;$iTXT.ui.TooltipChrome_Load=function(){var undefined;$iTXT.ui.TooltipChrome=$iTXT.core.Class.create($iTXT.ui.ComponentBase,{options:null,w:0,h:0,overlappedHeight:0,allowCustomHeader:true,init:function(_options,$super)
{var defOpts=$iTXT.core.Util.extend({id:"itxtchrome",ps:$iTXT.ui.TooltipPosition.AR},_options);$super(defOpts);$iTXT.core.$(document).itxtBatchSubscribe([["$iTXT:tt:global:set:bgcol",$iTXT.core.Event.bind(this,this._setBGCol)],["$iTXT:tt:global:set:hvcol",$iTXT.core.Event.bind(this,this._setHVCol)]],this.evtDspFuncs);},build:function()
{this.slideOut=new $iTXT.ui.TooltipSlideOut({});this.contentBG=$iTXT.core.Builder.make("DIV",{backgroundColor:this.options.bgcol,id:"itxtcontentbg"});this.contentBG.itxtSetStyle({backgroundColor:this.options.bgcol});this.rootElement.appendChild(this.contentBG);this.defaultHeader=this.header=new $iTXT.ui.TooltipHeader({ps:this.options.ps,bgcol:this.options.bgcol,draggable:this.options.draggable});this.header.build();this.defaultFooter=this.footer=new $iTXT.ui.TooltipFooter({ps:this.options.ps,bgcol:this.options.bgcol});this.footer.build();this.defaultTail=this.tail=new $iTXT.ui.TooltipTail({ps:this.options.ps,bgcol:this.options.bgcol});this.addChildren([this.slideOut,this.header,this.footer,this.tail]);},setPositionState:function(ps)
{this.options.ps=ps;if(this.tail)
this.tail.setPositionState(ps);this.resize(this.w,this.h);},setSize:function(w,h,overlap)
{overlap=overlap||0;var ttps=$iTXT.ui.TooltipPosition;this.width=w;var headerAndContentHeight=h+this.getHeaderHeight();this.height=headerAndContentHeight+
this.getFooterHeight()+
this.getTailHeight();this.overlappedHeight=Math.max(headerAndContentHeight+overlap,this.height);this.rootElement.itxtSetStyle({width:this.width+"px",height:this.overlappedHeight+"px"});if(this.contentBG)
this.contentBG.itxtSetStyle({width:this.width+"px",height:h+"px"});if((ttps.AR==this.options.ps)||(ttps.AL==this.options.ps))
{if(this.header)
...
if(this.tail)
{var tailLeft=(ttps.AR==this.options.ps)?50:(this.width-50-this.getTailWidth());this.tail.setPosition(tailLeft,h+this.getHeaderHeight()+this.getFooterHeight());}
if(this.contentBG)
...
if(this.tail)
{var tailLeft=(ttps.BR==this.options.ps)?50:(this.width-50-this.getTailWidth());this.tail.setPosition(tailLeft,0);}
if(this.contentBG)
...
{return((ttps.AR==this.options.ps)||(ttps.AL==this.options.ps))?0:this.getTailHeight();},setAdvert:function(ad,$super)
...
this.tail.tooltipOver();this._ubg();},tooltipOut:function()
{if(this.header)
this.header.tooltipOut();if(this.footer)
this.footer.tooltipOut();if(this.tail)
this.tail.tooltipOut();this._ubg();},getTailWidth:function()
...
{return(this.header)?this.header.getHeight():0}});}
...
$iTXT.js.loader["$iTXT.ui.MobileTooltipHeader"]=true;$iTXT.ui.MobileTooltipHeader_Load=function(){var undefined;$iTXT.ui.MobileTooltipHeader=$iTXT.core.Class.create($iTXT.ui.TooltipHeader,{init:function(_options,$super)
