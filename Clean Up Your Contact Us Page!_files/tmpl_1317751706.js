...
{var flvStr=decodeURIComponent(actualSrc.substring(qmIndex+1));this.extraFlashVars=$iTXT.core.Util.decodeQueryString(flvStr);this.properties.vars=$iTXT.core.Util.extend($iTXT.core.Util.objKeys(this.extraFlashVars),this.properties.vars);this.extraFlashVars["clickURL"]=undefined;actualSrc=actualSrc.substring(0,qmIndex);}
...
{this.advert.params.set(clickVarName,this.advert.params.get("A.CLICKURL"),$iTXT.cnst.WEIGHTING_DEFAULT_CAMPAIGN);}
...
{try
{$iTXT.debug.debug($iTXT.debug.Category.FLASH,"Calling Flash method <b>'."+opts.method+"()' for "+this.options.id);if(!opts.param)
{flmc[opts.method]();}
else
...
$iTXT.js.loader["$iTXT.tmpl.Html5Video"]=true;$iTXT.tmpl.Html5Video_Load=function(){var undefined;$iTXT.tmpl.Html5Video=$iTXT.core.Class.create($iTXT.tmpl.ElementBase,{init:function(_options,ad,$super)
...
{this.videoHldr.itxtSetStyle(this.options.styles);}}});}
