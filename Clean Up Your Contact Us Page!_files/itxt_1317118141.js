...
{var o=e.data||{};var ad=o.advert||$iTXT.ui.tt.currentAdvert;if(ad)
{this._logEvent("_trackEvent",[ad.params.get("iono"),"Unit Click",ad.hook.keyword],ad.params.get("A.AT"));if(ad.clickSource)
{this._logEvent("_trackEvent",[ad.params.get("iono"),"Unit Click: "+ad.clickSource,ad.hook.keyword],ad.params.get("A.AT"));}
var time=o.tso||$iTXT.ui.tt.getTimeSinceOpen();if(time)
{this._logEvent("_trackEvent",[ad.params.get("iono"),"Tooltip dwell time in ms",ad.hook.keyword,time],ad.params.get("A.AT"));}}},_ttOver:function(e)
...
{var o=e.data||{};var ad=o.advert||$iTXT.ui.tt.currentAdvert;if(ad)
{ad.gaMoused=false;var time=o.tso||$iTXT.ui.tt.getTimeSinceOpen();if(time)
{this._logEvent("_trackEvent",[ad.params.get("iono"),"Tooltip dwell time in ms",ad.hook.keyword,time],ad.params.get("A.AT"));}}},_ttMoved:function(e)
{var o=e.data||{};var ad=o.advert||$iTXT.ui.tt.currentAdvert;if(ad)
